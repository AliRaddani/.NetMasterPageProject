<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminModStudent.aspx.cs" Inherits="WebApplication1.adminModStudent" %>
    ...
    <form id="form1" runat="server" class="auto-style1">
        ...
        <nav class="navbar navbar-expand-sm navBarCustom">
            ...
            <div class="collapse navbar-collapse" id="collapsibleNavbar">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="color: #FFFFFF">> Modify Student</a>
                    </li>
                </ul>
            </div>
        ...
        <div class="row p-2">
            ...
            <div class="col-3">
                ...
                <br />
                <asp:TextBox ID="txt_studentID" runat="server" Enabled="False" BackColor="#CCCCCC">915156204</asp:TextBox>
                <br />
                <br />
                DestinyOne ID<br />
                <asp:TextBox ID="TextBox2" runat="server" Enabled="False" BackColor="#CCCCCC">123456</asp:TextBox>
                ...
                <br />
                <asp:TextBox ID="txt_studentName" runat="server" Enabled="False" BackColor="#CCCCCC">BRYANT, ASHLEY</asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lbl_studentDOB" runat="server" Text="Date of Birth"></asp:Label>
                <br />
                <asp:TextBox ID="txt_studentDOB" runat="server">10/15/1995</asp:TextBox>
                <br />
                <br />
            </div>
            <div class="col-3">
                ...
                <br />
                <asp:TextBox ID="txt_studentContactName" runat="server">Gina Bryant</asp:TextBox>
                <br />
                <br />
                <asp:Label ID="Label2" runat="server" Text="Relation"></asp:Label>
                <br />
                <asp:DropDownList ID="ddl_studentContactRelation" runat="server">
                ...
                <br />
                <asp:TextBox ID="txt_studentContactPhone" runat="server">215-123-1234</asp:TextBox>
                <br />
                <br />
                <asp:Label ID="txt_StudentEmail" runat="server" Text="Email"></asp:Label>
                <br />
                <asp:TextBox ID="txt_studentMail" runat="server" Width="151px">gina.bryant@gmail.com</asp:TextBox>
                <br />
                <br />
            ...
            <div class="col-3">
                ...
                <br />
                <asp:TextBox ID="txt_registrationDate" runat="server">11/04/2018</asp:TextBox>
                <br />
                <br />
                <asp:Label ID="lbl_studentModificationDate" runat="server" Text="Modification Date"></asp:Label>
                <br />
                <asp:TextBox ID="txt_studentModificationDate" runat="server">11/04/2019</asp:TextBox>
                <br />
                <br />
                <asp:Label ID="txt_studentRegistrationID" runat="server" Text="Registration ID"></asp:Label>
                <br />
                <asp:TextBox ID="txt_studentRegistrationDate" runat="server">123456</asp:TextBox>
                <br />
                <br />
            </div>
        </div>
        <div class="row p-2">
            <div class="col-3">
                ...
                <asp:RadioButtonList ID="rbl_studentIndLesson" runat="server">
                    <asp:ListItem Selected="True">Yes</asp:ListItem>
                    <asp:ListItem>No</asp:ListItem>
                </asp:RadioButtonList>
                <br />
                <asp:Label ID="txt_studentCGYM" runat="server" Text="CGYM"></asp:Label>
                <asp:RadioButtonList ID="rbl_studentCGYM" runat="server">
                    <asp:ListItem Selected="True">Yes</asp:ListItem>
                    <asp:ListItem>No</asp:ListItem>
                </asp:RadioButtonList>
                <br />
                <asp:Label ID="lbl_studentPhotoRelease" runat="server" Text="Photo Release"></asp:Label>
                <asp:RadioButtonList ID="rbl_studentPhotoRelease" runat="server">
                    <asp:ListItem Selected="True">Yes</asp:ListItem>
                    <asp:ListItem>No</asp:ListItem>
                </asp:RadioButtonList>
                <br />
                <br />
                <asp:Button ID="btn_studentModifySubmit" runat="server" Text="Save Student" OnClick="btn_studentModifySubmit_Click" />
                <br />
            </div>
